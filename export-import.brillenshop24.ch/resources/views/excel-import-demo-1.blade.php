...
@section('title', 'Excel Import Demo 1')
			...
			<div class="row">
			  <div class="col-md-6 offset-md-3">
				...
				<div class="tp-upload-box">
					<form id="uploadForm" action="{{url('excel-import-demo-1')}}" method="post" enctype="multipart/form-data">
						...
						<div class="tp-footer text-center">
							<input id="FileUploadId" type="text" class="display-none" value="{{ route('FileUpload.excel-import-demo-1') }}"/>
							<input id="ImportServerId" type="text" class="display-none" value="{{ route('ExcelImportServer-1.excel-import-demo-1') }}"/>

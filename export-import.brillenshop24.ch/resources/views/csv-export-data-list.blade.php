...
@section('title', 'Data List for CSV Export')
			...
			<div class="row">
				<div class="col">
					<div class="section-heading mb-20">
						<h2>Data List for CSV Export</h2>
					</div>
				</div>
			</div>
			<!-- Excel Export -->
					...
					<div class="panel-area">
						<div class="panel-header">
							<div class="inner-panel">
								<a href="{{url('csv-export-data')}}" class="btn btn-primary pull-right">
									<i class="fa fa-download"></i> CSV Export Products list
								</a>
							</div>
						</div>
